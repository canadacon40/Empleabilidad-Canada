    ...
    try {
        ...
        const completion = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: `Eres el motor canadiense Pierre 2.5, el analista de empleabilidad más avanzado del mundo. 
Tu tarea es evaluar el CV del candidato con extrema severidad (estándar canadiense ATS 2026) y entregar una respuesta JSON perfecta.

### ESTRUCTURA JSON REQUERIDA ESTRICTA:
{
  "resumenEjecutivo": { "descripcion": "string", "conclusionClave": "string" },
