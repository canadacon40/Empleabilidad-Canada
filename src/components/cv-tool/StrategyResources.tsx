            ...
            <div className="flex-1 flex flex-col min-h-0 relative">
                ...
                <main className="flex-1 overflow-y-auto no-scrollbar scroll-smooth relative overscroll-contain">
                    ...
                    <div className="max-w-[1400px] mx-auto p-4 sm:p-10 pb-48 sm:pb-32 animate-in fade-in slide-in-from-bottom-8 duration-700">
                        ...
                        <footer className="text-center opacity-40 pt-16 sm:pt-20 border-t border-slate-200 mt-16 sm:mt-20 px-4 flex flex-col items-center gap-6 pb-24 sm:pb-32">
                            <button 
                                onClick={() => {
                                    if (typeof window !== "undefined") {
                                        localStorage.clear();
                                ...
                                className="px-6 py-3 rounded-2xl bg-slate-100 hover:bg-slate-200 border-2 border-slate-200 text-slate-400 hover:text-red-500 font-balck text-[10px] uppercase tracking-widest transition-all"
                            >
